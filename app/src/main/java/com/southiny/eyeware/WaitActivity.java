...
public class WaitActivity extends AppCompatActivity {
    ...
    public static final String TAG = WaitActivity.class.getSimpleName();
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                // start main activity
                if (SplashScreen.isServiceRunning(ClockService.class.getName(), WaitActivity.this)) {
                    ...
                    if (nb < nbMax) {
                        ...
                        if (run.getParentalControl().isPasswordActivated()) {
                            ...
                            intent = new Intent(WaitActivity.this, PasswordActivity.class);
                        } else {
                            Logger.log(TAG, "start " + Main2Activity.class.getSimpleName() + "...");
                            intent = new Intent(WaitActivity.this, Main2Activity.class);
                        }
